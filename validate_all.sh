...
output_dir="./outputs_validate_all_2"  # Define the output directory
...
declare -a train_dataloader_type=("fixed_sampling")
...
#declare -a quantum_classif_models=("SAG_model_vqc" "MIAGAE_vqc")
#declare -a quantum_train_dataloader_type=("fixed_sampling" "random_sampling")
